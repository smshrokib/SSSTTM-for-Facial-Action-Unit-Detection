...
def parse_opt():
    ...
    parser.add_argument('--root', '-r', type=str, default='/home/qitam/sdb2/home/qiteam_project/roukai/Action-Unit-Detection/submission/aff2_processed')
    parser.add_argument('--exp_dir', '-ed', type=str, default='experiments/new/hrformer_AU_F1_MT_Loss')
    parser.add_argument('--cache_dir', '-cd', type=str, default='/home/qitam/sdb2/home/qiteam_project/roukai/Action-Unit-Detection/submission/Cached/cached_data')
    parser.add_argument('--lmdb_label_dir', '-lld', type=str, default='/home/qitam/sdb2/home/qiteam_project/roukai/Action-Unit-Detection/submission/LMDB')
    ...
    model.add_argument('--model_name', '-mn', type=str, default='hrformer')
    ...
    training.add_argument('-e', '--epochs', type=int, default=30, help='number of epochs')
    training.add_argument('-b', '--batch_size', type=int, default=256, help='minibatch size')
    training.add_argument('--gpu_id', type=int, default=5, help='gpu id')
    training.add_argument('--ema_gpu_id', type=int, default=6, help='gpu id')
    ...
    dataloader.add_argument('--n_frames', '--clip_len', type=int, default=1, help='the number of frames per clip')
