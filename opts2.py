...
def parse_opt():
    ...
    parser.add_argument('--exp_dir', '-ed', type=str, default='experiments/super/hrformer_1e-4')
    ...
    training.add_argument('--learning_rate', '-lr', default=1e-4, type=float, help='the initial learning rate')
    ...
    training.add_argument('--gpu_id', type=int, default=6, help='gpu id')
