...
def parse_opt():
    ...
    parser.add_argument('--exp_dir', '-ed', type=str, default='/home/qitam/sdb2/home/qiteam_project/roukai/Action-Unit-Detection/hrformer_AU_MT')
    ...
    training.add_argument('-b', '--batch_size', type=int, default=16, help='minibatch size')
    training.add_argument('--gpu_id', type=int, default=2, help='gpu id')
    training.add_argument('--ema_gpu_id', type=int, default=3, help='gpu id')
