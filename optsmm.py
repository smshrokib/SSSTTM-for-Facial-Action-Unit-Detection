...
def parse_opt():
    ...
    parser.add_argument('--exp_dir', '-ed', type=str, default='/home/qitam/sdb2/home/qiteam_project/roukai/Action-Unit-Detection/hrformer_AU')
    ...
    training.add_argument('--learning_rate', '-lr', default=1e-3, type=float, help='the initial learning rate')
    ...
    training.add_argument('--gpu_id', type=int, default=3, help='gpu id')
